...
from villager_chess_api.serializers import GameSerializer, CreateGameSerializer, CreateTournamentGameSerializer
...
class GameView(ViewSet):
    ...
    def create(self, request):
        ...
        serialized = CreateTournamentGameSerializer(data=request.data, many=False) if request.data['accepted'] == True else CreateGameSerializer(data=request.data, many=False)
